...
return {
  ...
  -- ),
  s(
    { trig = "bb(%w)", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta("\\mathbb{<>}", {
      f(function(_, snip)
  ...
  s(
    { trig = "overline", snippetType = "autosnippet" },
    fmta("\\overline{<>}", {
      i(1),
    }),
    { condition = tex.in_mathzone }
  ...
  -- s({ trig = "--", snippetType = "autosnippet" }, fmta("\\longleftrightarrow", {}), { condition = tex.in_mathzone }, condition = {tex.in_mathzone()}),
  -- s(
  ...
  s(
    { trig = "md", wordTrig = false, snippetType = "autosnippet" },
    fmta("\\left| <> \\right|", {
      i(1),
    }),
    { condition = tex.in_mathzone }
  ...
  s(
    { trig = "lrm", wordTrig = false, snippetType = "autosnippet" },
    fmta("\\left[ <> \\right]", {
      i(1),
    }),
    { condition = tex.in_mathzone }
