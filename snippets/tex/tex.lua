...
local math_symbols = {
	...
	}, { t("\\cdot") }, { condition = tex.in_mathzone }),
	s({
		trig = "o.",
		wordTrig = false,
		snippetType = "autosnippet",
	}, { t("\\odot") }, { condition = tex.in_mathzone }),
	s(
	...
	s({
		...
		wordTrig = false,
		snippetType = "autosnippet",
	}, { t("\\vdot") }, { condition = tex.in_mathzone }),
	s(
	...
	s({
		...
		wordTrig = false,
		snippetType = "autosnippet",
	}, { t("\\geq") }, { condition = tex.in_mathzone }),
	s({
		trig = "<=",
		wordTrig = false,
		snippetType = "autosnippet",
	}, { t("\\leq") }, { condition = tex.in_mathzone }),
	s(
	...
	s(
		{ trig = "aa", wordTrig = false, snippetType = "autosnippet" },
		{ t("\\forall") },
		{ condition = tex.in_mathzone }
	),
	s(
	...
	s({
		trig = "land",
		snippetType = "autosnippet",
	}, { t("\\land") }, { condition = tex.in_mathzone }),
	s({
		trig = "lor",
		snippetType = "autosnippet",
	}, { t("\\lor") }, { condition = tex.in_mathzone }),
	...
	s({ trig = "mid", wordTrig = false, snippetType = "autosnippet" }, { t("\\mid") }, { condition = tex.in_mathzone }),
	s({ trig = "cap", wordTrig = false, snippetType = "autosnippet" }, { t("\\cap") }, { condition = tex.in_mathzone }),
	s({ trig = "cup", wordTrig = false, snippetType = "autosnippet" }, { t("\\cup") }, { condition = tex.in_mathzone }),
	s(
	...
	-- Binary operations
	s({ trig = "+-", wordTrig = false, snippetType = "autosnippet" }, { t("\\pm") }, { condition = tex.in_mathzone }),
	s({ trig = "-+", wordTrig = false, snippetType = "autosnippet" }, { t("\\mp") }, { condition = tex.in_mathzone }),
	s(
		{ trig = "xx", wordTrig = false, snippetType = "autosnippet" },
		{ t("\\times") },
		{ condition = tex.in_mathzone }
	),
	s({ trig = "ss", wordTrig = false, snippetType = "autosnippet" }, { t("\\star") }, { condition = tex.in_mathzone }),
	s(
	...
	s({ trig = "**", wordTrig = false, snippetType = "autosnippet" }, { t("^*") }, { condition = tex.in_mathzone }),
	s({ trig = "tp", wordTrig = false, snippetType = "autosnippet" }, { t("^\\top") }, { condition = tex.in_mathzone }),
	s(
		{ trig = "dr", wordTrig = false, snippetType = "autosnippet" },
		{ t("^\\dagger") },
		{ condition = tex.in_mathzone }
	),
	s({ trig = "cc", snippetType = "autosnippet" }, { t("^c") }, { condition = tex.in_mathzone }),
	s({ trig = "++", snippetType = "autosnippet" }, { t("^+") }, { condition = tex.in_mathzone }),
	s({ trig = "--", snippetType = "autosnippet", priority = 2000 }, { t("^-") }, { condition = tex.in_mathzone }),
	...
	s({ trig = "po", snippetType = "autosnippet" }, { t("\\propto") }, { condition = tex.in_mathzone }),
	s({ trig = "##", wordTrig = false, snippetType = "autosnippet" }, { t("\\#") }, { condition = tex.in_mathzone }),

	-- Integrals
	s({ trig = "ii", snippetType = "autosnippet" }, { t("\\int") }, { condition = tex.in_mathzone }),
	s({ trig = "oii", snippetType = "autosnippet", priority = 2000 }, { t("\\oint") }, { condition = tex.in_mathzone }),
...
-- ============================================================
-- 2. GREEK LETTERS (greek-letter.lua)
-- ============================================================
local greek_letters = {
	-- Alpha
	s(
	...
	-- Beta
	s({ trig = ";b", snippetType = "autosnippet", wordTrig = false }, { t("\\beta") }, { condition = tex.in_mathzone }),
	s({ trig = ";B", snippetType = "autosnippet", wordTrig = false }, { t("\\Beta") }, { condition = tex.in_mathzone }),
	...
	-- Zeta
	s({ trig = ";z", snippetType = "autosnippet", wordTrig = false }, { t("\\zeta") }, { condition = tex.in_mathzone }),
	s({ trig = ";Z", snippetType = "autosnippet", wordTrig = false }, { t("\\Zeta") }, { condition = tex.in_mathzone }),

	-- Eta
	s({ trig = "eta", snippetType = "autosnippet", wordTrig = false }, { t("\\eta") }, { condition = tex.in_mathzone }),
	s({ trig = "Eta", snippetType = "autosnippet", wordTrig = false }, { t("\\Eta") }, { condition = tex.in_mathzone }),
	...
	-- Mu
	s({ trig = "mu", snippetType = "autosnippet", wordTrig = false }, { t("\\mu") }, { condition = tex.in_mathzone }),
	s({ trig = "Mu", snippetType = "autosnippet", wordTrig = false }, { t("\\Mu") }, { condition = tex.in_mathzone }),

	-- Nu
	s({ trig = "nu", snippetType = "autosnippet", wordTrig = false }, { t("\\nu") }, { condition = tex.in_mathzone }),
	s({ trig = "Nu", snippetType = "autosnippet", wordTrig = false }, { t("\\Nu") }, { condition = tex.in_mathzone }),

	-- Pi
	s({ trig = "pi", snippetType = "autosnippet", wordTrig = false }, { t("\\pi") }, { condition = tex.in_mathzone }),
	s(
	...
	-- Rho
	s({ trig = "rho", snippetType = "autosnippet", wordTrig = false }, { t("\\rho") }, { condition = tex.in_mathzone }),
	s({ trig = "Rho", snippetType = "autosnippet", wordTrig = false }, { t("\\Rho") }, { condition = tex.in_mathzone }),
	...
	-- Tau
	s({ trig = "tau", snippetType = "autosnippet", wordTrig = false }, { t("\\tau") }, { condition = tex.in_mathzone }),
	s({ trig = "Tau", snippetType = "autosnippet", wordTrig = false }, { t("\\Tau") }, { condition = tex.in_mathzone }),

	-- Upsilon
	s({ trig = "ups", snippetType = "autosnippet", wordTrig = false }, { t("\\ups") }, { condition = tex.in_mathzone }),
	s({ trig = "Ups", snippetType = "autosnippet", wordTrig = false }, { t("\\Ups") }, { condition = tex.in_mathzone }),

	-- Phi
	s({ trig = "phi", snippetType = "autosnippet", wordTrig = false }, { t("\\phi") }, { condition = tex.in_mathzone }),
	s({ trig = "Phi", snippetType = "autosnippet", wordTrig = false }, { t("\\Phi") }, { condition = tex.in_mathzone }),
	s(
	...
	-- Chi
	s({ trig = "chi", snippetType = "autosnippet", wordTrig = false }, { t("\\chi") }, { condition = tex.in_mathzone }),
	s({ trig = "Chi", snippetType = "autosnippet", wordTrig = false }, { t("\\Chi") }, { condition = tex.in_mathzone }),

	-- Psi
	s({ trig = "psi", snippetType = "autosnippet", wordTrig = false }, { t("\\psi") }, { condition = tex.in_mathzone }),
	s({ trig = "Psi", snippetType = "autosnippet", wordTrig = false }, { t("\\Psi") }, { condition = tex.in_mathzone }),
...
-- ============================================================
-- 3. MATH FONTS (font.lua)
-- ============================================================
local math_fonts = {
	-- Math font styles
	s({ trig = "msf", snippetType = "autosnippet" }, fmta("\\mathsf{<>}", { i(0) }), { condition = tex.in_mathzone }),
	...
	s({ trig = "bf", snippetType = "autosnippet" }, fmta("\\mathbf{<>}", { i(1) }), { condition = tex.in_mathzone }),

	s({ trig = "cal", snippetType = "autosnippet" }, fmta("\\mathcal{<>}", { i(0) }), { condition = tex.in_mathzone }),

	s({ trig = "scr", snippetType = "autosnippet" }, fmta("\\mathscr{<>}", { i(0) }), { condition = tex.in_mathzone }),

	s({ trig = "mbb", snippetType = "autosnippet" }, fmta("\\mathbb{<>}", { i(0) }), { condition = tex.in_mathzone }),

	s({ trig = "mrm", snippetType = "autosnippet" }, fmta("\\mathrm{<>}", { i(0) }), { condition = tex.in_mathzone }),
...
-- ============================================================
-- 4. MATH COMMANDS (math-commands.lua)
-- ============================================================
local math_commands = {
	-- Trigonometric functions
	s({ trig = "sin", snippetType = "autosnippet" }, { t("\\sin") }, { condition = tex.in_mathzone }),
	s({ trig = "asin", snippetType = "autosnippet" }, { t("\\arcsin") }, { condition = tex.in_mathzone }),
	s({ trig = "cos", snippetType = "autosnippet" }, { t("\\cos") }, { condition = tex.in_mathzone }),
	s({ trig = "acos", snippetType = "autosnippet" }, { t("\\arccos") }, { condition = tex.in_mathzone }),
	s({ trig = "tan", snippetType = "autosnippet" }, { t("\\tan") }, { condition = tex.in_mathzone }),
	s({ trig = "atan", snippetType = "autosnippet" }, { t("\\arctan") }, { condition = tex.in_mathzone }),
	s({ trig = "cot", snippetType = "autosnippet" }, { t("\\cot") }, { condition = tex.in_mathzone }),
	s({ trig = "acot", snippetType = "autosnippet" }, { t("\\arccot") }, { condition = tex.in_mathzone }),
	s({ trig = "csc", snippetType = "autosnippet" }, { t("\\csc") }, { condition = tex.in_mathzone }),
	s({ trig = "acsc", snippetType = "autosnippet" }, { t("\\arccsc") }, { condition = tex.in_mathzone }),
	s({ trig = "sec", snippetType = "autosnippet" }, { t("\\sec") }, { condition = tex.in_mathzone }),
	s({ trig = "asec", snippetType = "autosnippet" }, { t("\\arcsec") }, { condition = tex.in_mathzone }),

	-- Logarithms and exponentials
	s({ trig = "log", snippetType = "autosnippet" }, { t("\\log") }, { condition = tex.in_mathzone }),
	s({ trig = "ln", snippetType = "autosnippet" }, { t("\\ln") }, { condition = tex.in_mathzone }),
	s({ trig = "exp", snippetType = "autosnippet" }, { t("\\exp") }, { condition = tex.in_mathzone }),

	-- Vector calculus
	s({ trig = "grad", snippetType = "autosnippet" }, { t("\\grad") }, { condition = tex.in_mathzone }),
	s({ trig = "curl", snippetType = "autosnippet" }, { t("\\curl") }, { condition = tex.in_mathzone }),
	s({ trig = "div", snippetType = "autosnippet" }, { t("\\div") }, { condition = tex.in_mathzone }),
	s({ trig = "lap", snippetType = "autosnippet" }, { t("\\laplacian") }, { condition = tex.in_mathzone }),

	-- Blackboard bold
	s({ trig = "bbr", snippetType = "autosnippet" }, { t("\\mathbb{R}") }, { condition = tex.in_mathzone }),
	s({ trig = "bbq", snippetType = "autosnippet" }, { t("\\mathbb{Q}") }, { condition = tex.in_mathzone }),
	s({ trig = "bbh", snippetType = "autosnippet" }, { t("\\mathbb{H}") }, { condition = tex.in_mathzone }),
	s({ trig = "bbc", snippetType = "autosnippet" }, { t("\\mathbb{C}") }, { condition = tex.in_mathzone }),
	s({ trig = "bbz", snippetType = "autosnippet" }, { t("\\mathbb{Z}") }, { condition = tex.in_mathzone }),
	s({ trig = "bbn", snippetType = "autosnippet" }, { t("\\mathbb{N}") }, { condition = tex.in_mathzone }),
	s(
		{ trig = "bb1", snippetType = "autosnippet", priority = 2000 },
		{ t("\\mathbbm{1}") },
		{ condition = tex.in_mathzone }
	),
	s({ trig = "bbe", snippetType = "autosnippet" }, { t("\\mathbb{E}") }, { condition = tex.in_mathzone }),
	...
	s({ trig = "td", snippetType = "autosnippet" }, fmta("\\ttlde{<>}", { i(1) }), { condition = tex.in_mathzone }),
	...
	s({ trig = "hat", snippetType = "autosnippet" }, fmta("\\hat{<>}", { i(1) }), { condition = tex.in_mathzone }),

	s({ trig = "vec", snippetType = "autosnippet" }, fmta("\\vec{<>}", { i(1) }), { condition = tex.in_mathzone }),
	...
	s({ trig = "sch", snippetType = "autosnippet" }, { t("\\Sch") }, { condition = tex.in_mathzone }),
	...
	s({ trig = "ab", snippetType = "autosnippet" }, { t("\\ab") }, { condition = tex.in_mathzone }),
	...
	s({ trig = "ed", snippetType = "autosnippet" }, { t("\\ed") }, { condition = tex.in_mathzone }),
}

-- ============================================================
-- 5. ENVIRONMENTS (env.lua)
-- ============================================================
local environments = {
	-- Inline and display math
	s({ trig = "mk", snippetType = "autosnippet" }, fmta("\\(<>\\)", { i(1) }), { condition = tex.in_text }),
	...
	s({ trig = "im", snippetType = "autosnippet" }, { t("\\item") }, { condition = tex.in_item * line_begin }),
...
local physics_braket = {
	...
	s(
		{ trig = "ab", wordTrig = false, snippetType = "autosnippet", priority = 1000 },
